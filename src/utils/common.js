...
function formatDate(currentDate) { //定义日期格式化函数
...
function caculationRpxToPx(rpxsize) {
	...
	let caculationScreenWidth = systemInfo.screenWidth >= 480 ? 480 : systemInfo.screenWidth;
...
function paramKeySort(array) {
	...
	for (let i = 0; i < newKey.length; i++) {
		if (isNil(array[newKey[i]] + '') && (Object.prototype.toString.call(array[newKey[i]]) != '[object Object]' &&
			Object.prototype.toString.call(array[newKey[i]]) != '[object Array]')) {
			continue
		}
		if (Object.prototype.toString.call(array[newKey[i]]) == '[object Object]' || Object.prototype.toString.call(
			array[newKey[i]]) == '[object Array]') {
...
export function setNavigationBarColor(color) {
	let colorUtil = plus.android.newObject("android.graphics.Color");
	let activity = plus.android.runtimeMainActivity();
	let colorInt = plus.android.invoke(colorUtil, "parseColor", color);
