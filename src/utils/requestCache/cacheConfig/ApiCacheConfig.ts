...
export default {
  ...
  '/api/lottery/result/query/assistant/list': {
    cache: 10000,
    desc: '插叙助手获取列表 实时性较高 短时间缓存'
  },
  '/api/picture/detail': {
    forceUpdateCache: true,
    desc: '图片详情接口 缓存1分钟'
  },
  '/api/lottery/recharge/getRechargeGroup/v2': {
    forceUpdateCache: true,
    desc: '充值页获取公告接口'
  },
  '/api/article/detail': { forceUpdateCache: true, desc: '充值页获取公告接口' },
  '/api/lottery/detail/period': {
    forceUpdateCache: true,
    desc: '开奖信息接口'
  },
  '/api/lottery/getLotteryType': {
    forceUpdateCache: true,
    desc: '返点获取接口'
  },
  '/api/activityTask/types': {
    forceUpdateCache: true,
    desc: '活动类型菜单列表数据'
  },
  '/api/activityTask/details': {
    forceUpdateCache: true,
    desc: '活动菜单列表数据'
  },
