<template>
	<view class="home-my pc-max-width" :class="['theme-' + themeColor.name]"
		:style="{position: `fixed`, height:`${winHeight}px`,width:'100%', paddingTop: statusBarH }">
		...
		<AccountMess :userInfo="userInfo" :isLogin="isLogin" :isFixed="true" />
		<scroll-view scroll-y="true"
			:style="{height:`calc(${winHeight}px - 148rpx - 84rpx)`,marginTop:'148rpx',paddingBottom:'20rpx',boxSizing: 'border-box',backgroundColor:'#fff',borderTopLeftRadius:'24rpx',borderTopRightRadius:'24rpx',overflow:'hidden'}">
			<view class="content">
				<view class="content_blance">
					<view class="content_blance_top">
						...
						<view class="content_blance_top-li" style="margin-top: 20rpx;" v-if="isLogin">
							<view class="content_blance_top-li-left">
								...
								<text class="number" style="color: #F1CF78!important;">{{ parseInt(totalGold)||"0.00" }}</text>
							</view>
						</view>
						<view class="content_blance_top-li" style="margin-top: 20rpx;" v-else>
							<view class="content_blance_top-li-left">
								{{ $t('pages.common.userCenter.index.goldCoin') }}：
								<text class="number" style="color: #F1CF78!important;">0.00</text>
							</view>
						</view>
					...
					<view class="content_blance_bottom">
						<view class="content_blance_bottom-btn" @click="qidai">
				...
				<view class="body-middld">
					<view class="box-center">
						<view class="title" @click="qidai">{{ $t('pages.common.userCenter.index.essentialTools') }}
						</view>
						<view class="box-center-content">
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/spokesperson/apply')">
							...
							<view class="box-center-content-item" @click="toUrl('/pages/luntan/activity')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/level/level')">
								<view class="box-center-content-item-img">
					...
					<view class="box-center">
						...
						<view class="box-center-content">
							<view class="box-center-content-item" @click="toUrl()">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/homepage/homepage')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/collection/index')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/comment/index')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/mycare/index')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/backroom/index')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/mybackroomuser/index')">
								<view class="box-center-content-item-img">
					...
					<view class="box-center">
						...
						<view class="box-center-content">
							...
							<view class="box-center-content-item"
								@click="toUrl2('/pages/common/userCenter/service/index')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/feedback/index?type=2')">
								<view class="box-center-content-item-img">
									<image src="@/static/img/common/userCenter/icon-18.png" />
								</view>
							...
							<view class="box-center-content-item"
								@click="toUrl('/pages/common/userCenter/reportRecord/index')">
								<view class="box-center-content-item-img">
							...
							<view class="box-center-content-item"
								@click="openNewWindow('/#/pages/common/userCenter/downloadPage')">
								<!-- <uni-link href=""
			...
			<view v-if="false && $store.state.appInfoStore.configs && $store.state.appInfoStore.configs.isDebug"
				class="version-code" @click="testClick">
...
<script>
	import { details } from "@/utils/user/gold.js";
	...
	export default {
		...
		data() {
			return {
				...
				status: 0,
				statusBarH: this.$config.getStorageSync(this.$config.enumMgr.APP_LOCALSTORE_KEYS.SYSTEM_INFO)
					.statusBarHeight + "px",
				testTotalClick: 0,
				winHeight: 0,
			}
		...
		methods: {
			...
			getUserInfo() { //从storage获取用户信息
				...
				info(prams).then(res => {
					...
					this.$config.setStorageSync(this.$config.enumMgr.APP_LOCALSTORE_KEYS.LOCAL_STORE_USERINFO, this
						.userInfo);
				}).catch(err => {
					console.log(err)
				})
	...
	.home-my {
		...
		* {
		...
		.content {
			...
			// padding: 176rpx 28rpx 20rpx 28rpx;
