		...
		<Header :title="title" :isFixed="true" :headerStyle="{borderRadius:0,borderBottom:0}">
			<block slot="right">
				<view class="uni-list-cell-db" style="display:flex;justify-content: flex-end;">
					...
					<input class="uni-input" v-model="period" @blur="animalStat" @confirm="animalStat" />
				</view>
			</block>
		</Header>
		<scroll-view scroll-y class="scroll-y"
			:style="{height:`calc(${winHeight}px - 88rpx - 152rpx - var(--safe-area-inset-bottom))`, background: '#fff'}" :enhanced="true"
