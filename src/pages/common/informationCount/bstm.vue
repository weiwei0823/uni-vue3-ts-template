		...
		<Header :title="title" :isFixed="true" :headerStyle="{borderRadius:0,borderBottom:0}">
			<block slot="right">
				<view class="uni-list-cell-db" style="display:flex;justify-content: flex-end;">
					...
					<input class="uni-input" v-model="period" @blur="colorStat" @confirm="colorStat" />
				</view>
			</block>
		</Header>
	...
	export default {
		...
		data() {
			return {
				...
				type: 2,
				isActive: 0,
				colorList: this.$config.configUIMgr.colorPie,
				// colorList: ['#F5020A', '#02F707', '#0100F4'],
				hotData: {},
				coldData: {},
				winHeight: 0
			}
