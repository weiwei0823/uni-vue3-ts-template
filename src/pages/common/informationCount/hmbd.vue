<template>
	<view class="mint-tab-container-item" :style="{ marginTop: safeHeight }" :class="['theme-' + themeColor.name]">
		<!--顶部导航栏-->
		<Header :title="title" :headerStyle="{borderRadius:0,borderBottom:0}" isFixed>
			<block slot="right">
		...
		<scroll-view scroll-y class="scroll-y"
			:style="{height:`calc(${winHeight}px - 260rpx - var(--safe-area-inset-bottom))`, background: '#fff'}">
	...
	export default {
		...
		data() {
			return {
				...
				isInt: false,
				isActive: 0,
				colorList: ['#FD5308', '#3D01A4', '#8601AF', '#A7194B', '#FDD608'],
				hotData: {},
				coldData: {},
				winHeight: 0
			}
...
<style scoped>
	...
	.scroll-y {
		height: calc(var(--vh) - 200rpx - var(--safe-area-inset-bottom));
