		...
		<view class="top-head">
			<view class="top-hd">
				<view class="top-2">
					...
					<view class="ms">
						{{ rankList[1] ? rankList[1].count : 0 }}粉丝
					</view>
				</view>
				<view class="top-1">
					...
					<view class="ms">
						{{ rankList[0] ? rankList[0].count : 0 }}粉丝
					</view>
				</view>
				<view class="top-3">
					...
					<view class="ms">
						{{ rankList[2] ? rankList[2].count : 0 }}粉丝
					</view>
				</view>
			</view>
			<view class="my-top">
							...
							<view class="czz">
								<view class="user-top">
									<image @click="toHomePage(item)"
										...
										class="userImg" />
									<view class="user-text">
										<view class="name p-top">{{ item.username }}</view>
									</view>
								</view>
							</view>
						</uni-col>
...
<style lang="scss" scoped>
	.top-rank {
		min-height: var(--vh);
		background: linear-gradient(1turn, #e336ab, #f94078);
