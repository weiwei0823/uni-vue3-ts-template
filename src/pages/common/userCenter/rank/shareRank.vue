	...
	<view class="top-rank" :style="{ marginTop: safeHeight }">
		...
		<view class="top-head">
			<view class="top-hd">
				<view class="top-2">
					...
					<view class="name">{{ rankList[1] ? rankList[1].username : '' }}</view>
					<view class="ms">
						{{ rankList[1] ? rankList[1].count : 0 }}次
					</view>
				</view>
				<view class="top-1">
					...
					<view class="name">{{ rankList[0] ? rankList[0].username : '' }}</view>
					<view class="ms">
						{{ rankList[0] ? rankList[0].count : 0 }}次
					</view>
				</view>
				<view class="top-3">
					...
					<view class="name">{{ rankList[2] ? rankList[2].username : '' }}</view>
					<view class="ms">
						{{ rankList[2] ? rankList[2].count : 0 }}次
					</view>
				</view>
			</view>
			<view class="my-top">
		...
		<view class="rank-body-list">
			<view class="rank-list" v-if="otherRankList.length > 0">
				<view @click="toHomePage(item)" class="rank-list-item" v-for="(item, index) in otherRankList"
					:key="index">
					<uni-row>
						<uni-col :span="3">
						...
						<uni-col :span="15">
							<view class="czz">
								<view class="user-top">
									<image :src="item.headPic" class="userImg" />
									<view class="user-text">
...
<style lang="scss" scoped>
	.top-rank {
		min-height: var(--vh);
		background: linear-gradient(1turn, #62a6fd, #6f39fa);
