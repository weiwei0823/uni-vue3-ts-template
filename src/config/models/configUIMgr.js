...
export default {
	...
	checkPageElementIsHide(elementKey) {
		...
		let stationVersionCode = config?.stationVersionCode || enumConfig.STATION_VERSION_CODE.DEFAULT_CODE;
		let hideArray = this.PAGE_VERSION_HIDE_CONFIGS[stationVersionCode];
		if (!hideArray) {
			return false;
		}!this.memCheckPageElement[stationVersionCode] && (this.memCheckPageElement[stationVersionCode] = {})
