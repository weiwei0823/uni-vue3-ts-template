...
import imgCategory00 from "@/static/img/liuhe/index/category/c_0_0_0.png";
import imgCategory01 from "@/static/img/liuhe/index/category/c_0_0_1.png";
          ...
          setTimeout(() => {
			...
			getCategoryData() {
				...
				categoryData(prams).then(res => {
					if (res.code == 200) {
						const imgs = {
							'0_0': [imgCategory00, imgCategory01]
						}
