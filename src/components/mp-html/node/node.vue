<template>
	<view :id="attrs.id" :class="'_block _'+name+' '+attrs.class" :style="attrs.style">
		<block v-for="(n, i) in childs" v-bind:key="i">
			...
			<txv-video v-else-if="n.name=='txv-video'" :vid="n.attrs.vid" :playerid="n.attrs.vid" :id="n.attrs.vid"
				:class="n.attrs.class" :style="n.attrs.style" controls :data-i="i" @play="play" @error="mediaError" />
			<!-- 富文本 -->
				...
				if (href) {
					if (href[0] === '#') {
						...
						if (this.root.copyLink) {
							// #ifdef H5
							// window.open(href)
							this.$nativeBridge.openUrl(href);
							// #endif
							// #ifdef MP
